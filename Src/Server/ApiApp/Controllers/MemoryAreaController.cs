...
[ApiController]
[Route("[controller]")]
public class MemoryAreaController : Controller
{
    private readonly DataContext _context;
    private readonly IAesEncryptionService _aesEncryptionService;

    public MemoryAreaController(DataContext context, IAesEncryptionService aesEncryptionService)
    {
        _context = context;
    ...
    public IActionResult Post(string memoryAreaName)
    {
        ...
        MemoryAreaModel memoryArea = new MemoryAreaModel();
        memoryArea.Name = memoryAreaName;
        memoryArea.MaxGB = 30;
        memoryArea.Users = new List<UserModel>
        {
            user
        };
        memoryArea.EncryptionKey = _aesEncryptionService.RandomByteArray(32);
